...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:250px;" data-rule-required="true" data-msg-required="请填写评分" id="pingfen" name="pingfen" value="<%= Info.html(mmm.get("pingfen")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" id="pinglunneirong" name="pinglunneirong"><%= Info.html(mmm.get("pinglunneirong")) %></textarea>                                            
        </div>
    </div>
</div>
                                                    <div class="form-group">
