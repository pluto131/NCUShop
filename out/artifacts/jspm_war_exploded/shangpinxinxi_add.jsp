...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:250px;" id="shangpinmingcheng" name="shangpinmingcheng" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_fenlei3" data-value="" data-rule-required="true" data-msg-required="请填写分类" id="fenlei" name="fenlei" style="width:250px">
<% 
...
<% } %>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="hidden" data-rule-required="true" data-msg-required="请填写商品图片" id="shangpintupian" name="shangpintupian" value=""/>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" step="0.01" data-rule-required="true" data-msg-required="请填写商品价格" number="true" data-msg-number="输入一个有效数字" id="shangpinjiage" name="shangpinjiage" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写商品库存" number="true" data-msg-number="输入一个有效数字" id="shangpinkucun" name="shangpinkucun" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" id="shangpinxiaoliang" name="shangpinxiaoliang" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                                ...
                                                                <input type="hidden" name="dianpuxinxiid" value="<%= request.getParameter("id") !=null ? request.getParameter("id") : "" %>"/>
