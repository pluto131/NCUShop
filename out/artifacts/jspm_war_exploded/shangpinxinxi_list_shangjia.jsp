            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei2"
                        ...
                        <script>
                            $(".class_fenlei2").val($(".class_fenlei2").attr("data-value"))</script>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapshangpinfenlei4 = new CommDAO().find("SELECT fenlei FROM shangpinfenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapshangpinfenlei4.get("fenlei") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <a href="shangpinruku_add.jsp?id=<%= map.get("id") %>">商品入库</a>
