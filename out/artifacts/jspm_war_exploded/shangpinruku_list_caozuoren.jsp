...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
        ...
        if (request.getParameter("rukujiage_start") != null && !"".equals(request.getParameter("rukujiage_start"))) {
            where += " AND rukujiage >='" + request.getParameter("rukujiage_start") + "' ";
        }
        if (request.getParameter("rukujiage_end") != null && !"".equals(request.getParameter("rukujiage_end"))) {
            where += " AND rukujiage <='" + request.getParameter("rukujiage_end") + "' ";
        }
        List<HashMap> list = Query.make("shangpinruku").where(where).order(orderby + " " + sort).page(15);
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei16"
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr align="center">
                        ...
                        <th> 入库备注</th>
                        <th> 操作人</th>
                        <th width="120" data-field="addtime">入库时间</th>
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapshangpinfenlei18 = new CommDAO().find("SELECT fenlei FROM shangpinfenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapshangpinfenlei18.get("fenlei") %>
                        </td>
                        ...
                        <td><%= map.get("rukujiage") %>
                        </td>
                        <td><%= map.get("rukubeizhu") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <a href="shangpinruku.jsp?a=delete&id=<%= map.get("id") %>"
