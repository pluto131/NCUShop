...
new CommDAO().commOper("update shangpindingdan set dingdanzhuangtai='已签收' where dingdanhao='"+request.getParameter("dingdanhao")+"'");

new CommDAO().commOper("update fahuo set zhuangtai='已签收' where id='"+request.getParameter("fahuoid")+"'");
