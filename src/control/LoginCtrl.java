    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ac.equals("login")) {
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                String sql1 = "";
                                                                                                                                                                                if (utype.equals("商家")) {
                                        sql1 = "select * from shangjia where shangjiazhanghao='" + username + "' and mima='" + password + "' ";
                }
                                                                                                if (utype.equals("会员")) {
        ...
        if (ac.equals("adminuppass")) {
            ...
            String biao = "";
                ...
                // dao.getmaps("username", (String) request.getSession().getAttribute("username"), "admins");
                        ...
                        if(cx.equals("商家")){
                biao = "shangjia";
                                m = Query.make(biao).where("shangjiazhanghao",username).where("mima",olduserpass).find();
                // dao.getmaps("shangjiazhanghao", (String) request.getSession().getAttribute("username"), "shangjia");
                            }
                        if(cx.equals("会员")){
                biao = "huiyuan";
            ...
            if (m == null || m.isEmpty()) {
                ...
                String sql = "";
                    ...
                    sql = "UPDATE admins SET pwd='"+userpass+"' WHERE username='"+username+"'";
                                ...
                                if(cx.equals("商家")){
                    sql = "UPDATE shangjia SET mima='"+userpass+"' WHERE shangjiazhanghao='"+username+"'";
                }
                                if(cx.equals("会员")){
